...
//Source: errorPage403.rsp.html
part of trails;

/** Template, errorPage403, for rendering the view. */
Future errorPage403(HttpConnect connect) { //#2
...
<html>
 <head>
     <title>La Boussole - opération non autorisée</title>
"""); //#2
...
"""); //#7
    ...
    response.write("""           <h1>Opération non autorisée</h1>
"""); //#11
    ...
    var _2 = new StringBuffer(); _cs_.add(connect); //var#14
    connect = new HttpConnect.stringBuffer(connect, _2); response = connect.response;

    connect = _cs_.removeLast(); response = connect.response;

    var _3 = new StringBuffer(); _cs_.add(connect); //var#15
